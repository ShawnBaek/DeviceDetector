...
final class DeviceDetectorTests: XCTestCase {
    ...
    func test_all_devices_from_plist() throws {
        devicesDict.allKeys.compactMap { $0 as? String }.forEach {
            XCTAssertNotEqual(DeviceDetector.current.device(id: $0), .unrecognized)
        }
    }
    ...
    func test_simulator() throws {
        ...
        simulator.forEach {
            let device = DeviceDetector.current.device(id: $0)
    ...
    func test_iPod() throws {
        let iPod7th = "iPod9,1"
        let device = DeviceDetector.current.device(id: iPod7th)
    ...
    func test_iPhoneSE() throws {
        ...
        let iPhoneSE1Device = DeviceDetector.current.device(id: iPhoneSE1)
        ...
        let iPhoneSE2Device = DeviceDetector.current.device(id: iPhoneSE2)
        ...
        let iPhoneSE3Device = DeviceDetector.current.device(id: iPhoneSE3)
    ...
    func test_iPhone6() throws {
        ...
        let iPhone6Device = DeviceDetector.current.device(id: iPhone6)
        ...
        let iPhone6PlusDevice = DeviceDetector.current.device(id: iPhone6Plus)
    ...
    func test_iPhoneX() throws {
        ...
        let iPhoneXSDevice = DeviceDetector.current.device(id: iPhoneXS)
        ...
        let iPhoneXRDevice = DeviceDetector.current.device(id: iPhoneXR)
    ...
    func test_iPhone11() throws {
        ...
        let iPhone11Device = DeviceDetector.current.device(id: iPhone11)
        ...
        let iPhone11ProDevice = DeviceDetector.current.device(id: iPhone11Pro)
        ...
        let iPhone11ProMaxDevice = DeviceDetector.current.device(id: iPhone11ProMax)
    ...
    func test_iPhone12() throws {
        ...
        let iPhone12MiniDevice = DeviceDetector.current.device(id: iPhone12Mini)
        ...
        let iPhone12Device = DeviceDetector.current.device(id: iPhone12)
        ...
        let iPhone12ProDevice = DeviceDetector.current.device(id: iPhone12Pro)
        ...
        let iPhone12ProMaxDevice = DeviceDetector.current.device(id: iPhone12ProMax)
    ...
    func test_iPhone13() throws {
        ...
        let iPhone13MiniDevice = DeviceDetector.current.device(id: iPhone13Mini)
        ...
        let iPhone13Device = DeviceDetector.current.device(id: iPhone13)
        ...
        let iPhone13ProDevice = DeviceDetector.current.device(id: iPhone13Pro)
        ...
        let iPhone13ProMaxDevice = DeviceDetector.current.device(id: iPhone13ProMax)
